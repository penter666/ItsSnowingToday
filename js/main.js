...
function Spider(game, x, y) {
    Phaser.Sprite.call(this, game, x, y, 'spiderR');
...
Spider.prototype.move = function (direction) {
    this.body.velocity.x = direction * SPEED;
...
PlayState.preload = function () {
    ...
    this.game.load.spritesheet('spiderR', 'images/spiderR.png', 42, 32);
    this.game.load.spritesheet('hero', 'images/hero.png', 42, 42);
...
PlayState.create = function () {
    ...
    this.game.add.image(0, 0, 'parallax');
